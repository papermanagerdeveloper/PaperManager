...
<body>
	...
	<%	
		...
		studentList = (ArrayList<Map>)stu.getStudentByTeacherID(teacherID); 
	%>
		...
		<table align = "center" border = "1">
			...
			<%
				for(Map student:studentList) {
					...
					Map<String,String> title =tit.titleQuery(titleID);
					...
					/*查询这一行的学生的成绩*/
					Grade grade =new Grade((String)student.get("ID"));	
					/*添加该行的每一项*/
					/*学生ID*/
					out.print("<td>");
					...
					/*学生成绩*/
					out.print("<td>");
					out.print("<input type = 'text' name = '"+student.get("ID")+"' value = '"+grade.getGrade()+"' />");
					out.print("</td>");
